...
const getEventIcon = (type: EventType) => {
  ...
  return (
    <PageLayout title="Commander View" icon={<Crown className="w-6 h-6 text-yellow-400" />}>
      <div className="commander-view">
        {/* Main Dashboard Grid */}
        <div className="commander-view__grid">
          
          {/* Large Tactical Map - Central Focus */}
          <div className="commander-view__panel commander-view__panel--col-span-8 commander-view__panel--row-span-3">
          ...
          <div className="commander-view__panel commander-view__panel--col-span-4">
            <div className="commander-view__panel-header">
              <h3 className="commander-view__panel-title" style={{ color: '#1976FF' }}>MISSION STATUS</h3>
          ...
          <div className="commander-view__panel commander-view__panel--col-span-6">
            <div className="commander-view__panel-header">
              <h3 className="commander-view__panel-title" style={{ color: '#00E3B2' }}>ASSET STATUS</h3>
          ...
          <div className="commander-view__panel commander-view__panel--col-span-3">
            <div className="commander-view__panel-header">
              <h3 className="commander-view__panel-title" style={{ color: '#00E3B2' }}>INTELLIGENCE</h3>
          ...
          <div className="commander-view__panel commander-view__panel--col-span-3">
            <div className="commander-view__panel-header">
              <h3 className="commander-view__panel-title" style={{ color: '#FFC107' }}>RECENT EVENTS</h3>
          ...
          {/* System Status */}
          <div className="commander-view__panel commander-view__panel--col-span-12">
            <div className="commander-view__panel-header">
              <h3 className="commander-view__panel-title" style={{ color: '#9C27B0' }}>SYSTEM STATUS</h3>
